class EventosHorariosMarcadosModel {
  int? id;
  String? nomeEvento;
  bool? isIninterrupta;
  String? horaInicial;
  ...
  EventosHorariosMarcadosModel({this.id, this.nomeEvento, this.isIninterrupta, this.horaInicial, this.horaFinal, this.status});

  EventosHorariosMarcadosModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
